...
| Fraud evaluation | Paper-ready metrics | Complete synthetic evaluation (precision 0.8974, recall 0.9722, F1 0.9333) with boundary analysis | 90% | Real-world field labels required only for extended journal claims |
